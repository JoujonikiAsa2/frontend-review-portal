  ...
  <div className="p-4 flex flex-col flex-grow text-foreground">
    ...
    <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-gray-700">
      <div className="flex space-x-3">
        <button
          className={`flex items-center space-x-1 ${userVote === "up" ? "text-foreground" : "text-muted-foreground"} hover:text-foreground transition-colors`}
        ...
        <button
          className={`flex items-center space-x-1 ${userVote === "down" ? "text-red-600" : "text-muted-foreground"} hover:text-red-700 dark:hover:text-red-500 transition-colors`}
