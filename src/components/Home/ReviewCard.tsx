...
export default function ReviewHomeCard({ review }) {
  ...
  const getCategoryColor = (category) => {
    ...
    return categories[category] || "bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-200";
  };
    ...
    <div className="h-96 flex flex-col rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mb-2">
          <span className="mr-2">{review.authorName || "Anonymous"}</span>
          <div className="flex items-center">
            <Clock size={12} className="mr-1" />
            {review.publishDate || "Recent"}
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-gray-700">
          <div className="flex space-x-3">
            ...
            >
              <ThumbsUp
                size={16}
                className={userVote === "up" ? "fill-gray-900 dark:fill-white" : ""}
              />
            ...
            >
              <ThumbsDown
                size={16}
                className={userVote === "down" ? "fill-gray-900 dark:fill-white" : ""}
              />
