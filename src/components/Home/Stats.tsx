        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-12">
          ...
          <div className="md:max-w-xl">
            <p className="text-lg text-gray-700 mb-10 leading-relaxed">
              Join our thriving community of reviewers! With thousands of reviews and 
              active users, we provide insights that matter.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-8">
              ...
              <div className="bg-white p-6 rounded-sm border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <p className={`text-5xl sm:text-6xl font-bold mb-2 transition-all duration-1000 ${animateStats ? 'opacity-100' : 'opacity-0 -translate-y-4'}`}>
              ...
              <div className="bg-white p-6 rounded-sm border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <p className={`text-5xl sm:text-6xl font-bold mb-2 transition-all duration-1000 delay-300 ${animateStats ? 'opacity-100' : 'opacity-0 -translate-y-4'}`}>
            ...
            <div className="mt-10 flex items-center space-x-4">
              ...
              <button className="group flex items-center font-medium text-black hover:text-gray-700 transition-colors">
                Explore 
